        ...
        switch (colorofpiece){
            ...
            case Board.BLACKKING:
                for(i=row-1,j=column-1;i>0 && j>0;i--,j--) {
                    if (checkLeftTopDiagonalEmptySpaces(column, row, j, i)) {
                ...
                for(i=row+1,j=column-1;i<7 && j>0;i++,j--) {
                    if (checkLeftBotDiagonalEmptySpaces(column, row, j, i)) {
                        if (frame.board.getValueOfPiece(i, j) == Board.REDKING || frame.board.getValueOfPiece(i, j) == Board.RED) {
                            if (frame.board.getValueOfPiece(i + 1, j - 1) == Board.EMPTY) {
                                result = true;
                            }
                ...
                for(i=row-1,j=column+1;i>0 && j<7;i--,j++) {
                    if (checkRightTopDiagonalEmptySpaces(column, row, j, i)) {
                        if (frame.board.getValueOfPiece(i, j) == Board.REDKING || frame.board.getValueOfPiece(i, j) == Board.RED) {
                            if (frame.board.getValueOfPiece(i - 1, j + 1) == Board.EMPTY) {
                                result = true;
                            }
                ...
                for(i=row+1,j=column+1;i<7 && j<7;i++,j++) {
                    if (checkRightBotDiagonalEmptySpaces(column, row, j, i)) {
                        if (frame.board.getValueOfPiece(i, j) == Board.REDKING || frame.board.getValueOfPiece(i, j) == Board.RED) {
                            if (frame.board.getValueOfPiece(i + 1, j + 1) == Board.EMPTY) {
                                result = true;
                            }
